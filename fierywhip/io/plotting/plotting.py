...
class Plots:
    ...
    def separation_det(self):
        ...
        for d in nai:
            ...
            seps = dlist[1]
            vals = dlist[3]
            axes[det_id].set_title(d)
            axes[det_id].errorbar(
                seps,
                vals,
            ...
            axes[det_id].set_xlim(0, 180)
            axes[det_id].set_ylim(0, 2)
        fig.savefig(os.path.join(self._base_dir, "test.pdf"))
